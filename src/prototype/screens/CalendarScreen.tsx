    ...
    <>
      ...
      >
        ...
        <div style={S('padding:16px 22px 0')}>
          ...
          >
            {v.sel.hasDur ? (
              <>
                <div
                  style={S('font-size:12px;line-height:1.5;color:#6E6A60;font-weight:600;margin-bottom:14px')}
                >
                  {v.sel.durNote}
                </div>
              </>
            ...
            {v.sel.hasTime ? (
              <>
                <div>
                  ...
                  <div className={'ffs'} style={S('display:flex;gap:7px;overflow-x:auto;padding-bottom:2px')}>
        ...
        <div style={S('padding:16px 22px 0')}>
          ...
          >
            <h3 style={S('margin:0;font-size:17px;font-weight:900;letter-spacing:-.02em')}>Meals that day</h3>
            <div
              style={S(
