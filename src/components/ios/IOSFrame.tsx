 ...
 *
 * Carried over from the prototype's `ios-frame.jsx` — the bezel, dynamic island,
 * status bar and home indicator that the ATHLY screens are presented inside. No
 * assets and no dependencies; every part is drawn with CSS and inline SVG.
 *
 * `IOSDevice` is the piece the app uses. The rest (nav bar, grouped list,
 * keyboard) is kept because it belongs to the same frame vocabulary and is what
 * any additional screen mock-up would reach for.
 */
